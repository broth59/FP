...
exports.takeUntil = _.curry(function (f, iter) {
    iter = L.each(iter);
    iter.return = null;
    var res = [];
    return (function recurr() {
        ...
        var _loop_1 = function (key, val) {
            ...
            if (b instanceof Promise) {
                return { value: b
                        .then(function (c) { return __awaiter(_this, void 0, void 0, function () { var _a, _b, _c; return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                if (!c) return [3, 2];
                                _c = (_b = res).push;
                        ...
                        .catch(function (e) { return (e == symbol_1.nop ? recurr() : Promise.reject(e)); }) };
            }
            else {
                res.push(val);
            }
