...
//     iter: Iterable<Yield> | Promise<Iterable<Yield>>,
//     fn1: (arg: Iterable<Yield>) => R1
// ): R1
export function go<Yield, R1>(iter: Promise<Yield> | Yield, fn1: (arg: Yield) => R1): R1

// export function go<Yield, R1, R2>(
//     iter: Iterable<Yield> | Promise<Iterable<Yield>>,
//     fn1: (arg: Iterable<Yield>) => Iterable<R1> | R1,
//     fn2: (arg: Iterable<R1> | R1) => R2
// ): R2
export function go<Yield, R1, R2>(
    iter: Promise<Yield> | Yield,
