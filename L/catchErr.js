            ...
            case 0:
                ...
                _loop_1 = function (key, val) {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(val instanceof Promise)) return [3, 2];
                                return [4, val.catch(function (e) { var _a; return (e == symbol_1.nop ? symbol_1.noop : (_a = fn(e, val)) !== null && _a !== void 0 ? _a : symbol_1.noop); })];
                            case 1:
                                _a.sent();
                                return [3, 4];
                            case 2: return [4, val];
